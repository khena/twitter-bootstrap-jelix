...
function jtpl_function_html_jmessage_bootstrap($tpl, $type = '') {
    ...
    if ($type == '') {
        foreach ($messages as $type_msg => $all_msg) {
            ...
            elseif($type_msg == 'ok')
                $type_msg = 'success';
            echo '<div class="alert-message '.$type_msg.' fade in" data-alert="alert"><a class="close" href="#">×</a>';
        ...
        echo '<div class="alert-message '.$type.' fade in" data-alert="alert"><a class="close" href="#">×</a>';
